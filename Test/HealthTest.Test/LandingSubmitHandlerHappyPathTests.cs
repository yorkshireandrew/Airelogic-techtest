...
{
    public class LandingSubmitHandlerHappyPathTests
    {
        ...
        [Fact]
        public async Task Handle_FindsPatient_ReturnsAgeBandJson()
        {
            ...
            patientMock.Setup(p => p.CalculateAge(It.IsAny<System.DateTime>())).Returns(30);
            ...
            ageBandMock.Setup(a => a.CalculateAgeBand(It.IsAny<int>())).Returns(2);
            ...
            Assert.Equal(2, json.AgeBand);
            Assert.Equal(string.Empty, json.Message);
        }
    }
}
